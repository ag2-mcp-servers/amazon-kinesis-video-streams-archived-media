...
from models import (
    ...
    GetDASHStreamingSessionURLPostRequest,
    GetHLSStreamingSessionURLOutput,
    GetHLSStreamingSessionURLPostRequest,
    GetImagesOutput,
    GetImagesPostRequest,
    GetMediaForFragmentListOutput,
    GetMediaForFragmentListPostRequest,
    InvalidArgumentException,
    InvalidCodecPrivateDataException,
    InvalidMediaFrameException,
    ListFragmentsOutput,
    ListFragmentsPostRequest,
...
@app.post(
    ...
    tags=['streaming_session_management', 'media_file_handling'],
    security=[
...
@app.post(
    ...
    tags=['streaming_session_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
def get_d_a_s_h_streaming_session_u_r_l(
    x__amz__content__sha256: Optional[str] = Header(None, alias='X-Amz-Content-Sha256'),
    x__amz__date: Optional[str] = Header(None, alias='X-Amz-Date'),
    x__amz__algorithm: Optional[str] = Header(None, alias='X-Amz-Algorithm'),
    x__amz__credential: Optional[str] = Header(None, alias='X-Amz-Credential'),
    ...
    x__amz__signature: Optional[str] = Header(None, alias='X-Amz-Signature'),
    x__amz__signed_headers: Optional[str] = Header(None, alias='X-Amz-SignedHeaders'),
    body: GetDASHStreamingSessionURLPostRequest = ...,
):
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
def get_h_l_s_streaming_session_u_r_l(
    x__amz__content__sha256: Optional[str] = Header(None, alias='X-Amz-Content-Sha256'),
    x__amz__date: Optional[str] = Header(None, alias='X-Amz-Date'),
    x__amz__algorithm: Optional[str] = Header(None, alias='X-Amz-Algorithm'),
    x__amz__credential: Optional[str] = Header(None, alias='X-Amz-Credential'),
    ...
    x__amz__signature: Optional[str] = Header(None, alias='X-Amz-Signature'),
    x__amz__signed_headers: Optional[str] = Header(None, alias='X-Amz-SignedHeaders'),
    body: GetHLSStreamingSessionURLPostRequest = ...,
):
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
def get_media_for_fragment_list(
    ...
    x__amz__signature: Optional[str] = Header(None, alias='X-Amz-Signature'),
    x__amz__signed_headers: Optional[str] = Header(None, alias='X-Amz-SignedHeaders'),
    body: GetMediaForFragmentListPostRequest = ...,
):
    raise RuntimeError("Should be patched by MCPProxy and never executed")
